package com.hdgd.config;

import com.hdgd.config.handler.*;
import com.hdgd.config.service.UserDetailsServiceImpl;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    CorsConfigurationSource corsConfigurationSource(){
        return httpServletRequest -> {
            ...
            cfg.addAllowedOrigin("http://192.168.43.94:8088");
            //cfg.addAllowedOrigin("http://47.115.190.50:8088");
            cfg.addAllowedHeader("*");
            cfg.addAllowedMethod("*");
            cfg.addAllowedOrigin("http://localhost:8088");
            //cfg.addAllowedOrigin("http://47.115.190.50:8088");

            //cfg.checkOrigin("http://192.168.43.94:8080");
